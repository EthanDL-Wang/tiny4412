...
{
    printf("%s %d flag=%d argc=%d\n", __FUNCTION__, __LINE__, flag, argc);
...
static int bootm_linux_fdt(int machid, bootm_headers_t *images)
{
    ...
    printf("%s %d images->ep=%08lx\n", __FUNCTION__, __LINE__, images->ep);
    printf("%s %d ret=%d *initrd_start=%08lx\n", __FUNCTION__, __LINE__, ret, *initrd_start);
