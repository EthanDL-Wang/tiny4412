...
#define LINUX_ZIMAGE_MAGIC	0x016f2818
    ...
    printf("%s %d addr=0x%08lx\n", __FUNCTION__, __LINE__, addr);
    printf("%s %d *(ulong *)(addr + 9*4)=0x%08lx\n", __FUNCTION__, __LINE__, *(ulong *)(addr + 9*4));
    ...
    printf("%s %d images.os.type =%d\n", __FUNCTION__, __LINE__, images.os.type);
...
after_header_check:
	...
	boot_fn = boot_os[images.os.os];
    printf("%s %d boot_fn=%p images.os.os=%d\n", __FUNCTION__, __LINE__, boot_fn, images.os.os);
	if (boot_fn == NULL) {
		if (iflag)
			enable_interrupts();
